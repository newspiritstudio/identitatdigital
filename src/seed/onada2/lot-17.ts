  ...
  companies: [
    {
      ...
      leadSupervisoryAuthority: 'Cap autoritat principal a la UE: no consta establiment únic al territori europeu',
      ownership: 'private',
      foundedYear: 2001,
    ...
    },
    {
      ...
      leadSupervisoryAuthority:
        'Cap: Duolingo, Inc. actua com a responsable des dels Estats Units, emparada en el Marc de Privadesa de Dades UE-EUA',
      ownership: 'public',
      foundedYear: 2011,
    ...
    },
    {
      ...
      euEstablishment: 'SI',
      leadSupervisoryAuthority: 'Informacijski pooblaščenec (Eslovènia)',
      ownership: 'private',
      primaryRevenueModel: 'freemium',
    ...
    },
    {
      ...
      headquartersCountry: 'US',
      leadSupervisoryAuthority:
        'Cap: Instructure, Inc. tracta les dades europees emparada en el Marc de Privadesa de Dades UE-EUA; Instructure Global Ltd. dona cobertura al Regne Unit',
      ownership: 'private',
      foundedYear: 2008,
      primaryRevenueModel: 'subscription',
    ...
    },
    {
      ...
      headquartersCountry: 'US',
      leadSupervisoryAuthority:
        'Cap autoritat principal: Preply, Inc. és responsable des dels Estats Units i designa un representant a la UE a Barcelona',
      ownership: 'private',
      foundedYear: 2012,
