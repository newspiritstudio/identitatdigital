...
export const lot: SeedLot = {
  companies: [
    ...
    {
      slug: 'apple-distribution-international',
      name: 'Apple Distribution International',
      legalName: 'Apple Distribution International Limited',
      parent: 'apple',
      description:
        'Filial irlandesa d’Apple, amb seu a Hollyhill (Cork), que la política de privadesa d’Apple identifica com a responsable del tractament de les dades personals de les persones de l’Espai Econòmic Europeu, el Regne Unit i Suïssa.',
