...
export const lot: SeedLot = {
  companies: [
    ...
    },
    {
      slug: 'prisa-media',
      name: 'PRISA Media',
      legalName: 'PRISA MEDIA, S.A.U.',
      parent: 'prisa',
      description:
        'Societat del Grup PRISA que comercialitza els espais publicitaris de totes les capçaleres del grup. Les polítiques d’EL PAÍS i de la Cadena SER la declaren corresponsable del tractament al costat de l’editora.',
      headquartersCountry: 'ES',
      euEstablishment: 'ES',
      leadSupervisoryAuthority: 'Agencia Española de Protección de Datos',
      ownership: 'subsidiary',
      primaryRevenueModel: 'advertising',
      website: 'https://www.prisamedia.com/',
      privacyContact: 'dpo@prisa.com',
    },
    {
