  ...
  companies: [
    {
      ...
      leadSupervisoryAuthority: 'No en té: a la UE hi actua per mitjà del representant Osano International Compliance Services Limited (Dublín)',
      ownership: 'public',
      foundedYear: 2008,
    ...
    },
    {
      ...
      euEstablishment: 'FR',
      leadSupervisoryAuthority: 'CNIL (França)',
      ownership: 'private',
      foundedYear: 2022,
    ...
    },
    {
      ...
      euEstablishment: 'CY',
      leadSupervisoryAuthority: 'Οffice of the Commissioner for Personal Data Protection (Xipre)',
      ownership: 'subsidiary',
      primaryRevenueModel: 'freemium',
      website: 'https://bumpy.app/',
      productDomains: ['bumpy.app', 'wonder.dating'],
    ...
    },
    {
      slug: 'hyperconnect',
      name: 'Hyperconnect',
      legalName: 'Hyperconnect LLC',
      parent: 'match-group',
      description:
        'Empresa coreana que va crear Azar i Hakuna, comprada per Match Group el 2021. És el responsable del tractament fora de l’EEE, el Regne Unit i Suïssa; dins de l’EEE ho és MTCH Technology Services Limited, de Dublín.',
      headquartersCountry: 'KR',
      ownership: 'subsidiary',
      foundedYear: 2014,
      primaryRevenueModel: 'freemium',
      website: 'https://hpcnt.com/',
      productDomains: ['azarlive.com', 'hpcnt.com'],
    },
  ],
