...
export const lot: SeedLot = {
  companies: [
    ...
    },
    {
      ...
      euEstablishment: 'ES',
      leadSupervisoryAuthority: 'Integritetsskyddsmyndigheten',
      ownership: 'private',
      foundedYear: 2011,
    ...
    },
    {
      ...
      euEstablishment: 'BG',
      leadSupervisoryAuthority: 'Комисия за защита на личните данни',
      ownership: 'private',
    ...
    },
    {
      ...
      headquartersCountry: 'CA',
      euEstablishment: 'LU',
      leadSupervisoryAuthority: 'Commission nationale pour la protection des données',
