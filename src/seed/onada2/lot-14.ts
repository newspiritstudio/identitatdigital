...
const companies: CompanySeed[] = [
  ...
  },
  {
    ...
    euEstablishment: 'FR',
    leadSupervisoryAuthority: 'Commission nationale de l’informatique et des libertés (CNIL)',
    ownership: 'private',
    foundedYear: 1999,
    primaryRevenueModel: 'commerce',
    website: 'https://www.winamax.es/',
  ...
  },
  {
    ...
    euEstablishment: 'MT',
    leadSupervisoryAuthority: 'Information and Data Protection Commissioner (Malta)',
    ownership: 'subsidiary',
    primaryRevenueModel: 'commerce',
    website: 'https://www.bet365.com/',
    productDomains: ['bet365.com', 'bet365.es'],
