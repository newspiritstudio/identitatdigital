  ...
  return (
    <div className="content-wrapper">
      <div className="text-page">
        ...
        <p className="lede">
          Una foto feta amb el mòbil pot portar les coordenades exactes d’on la vas fer. Un document
          de Word, el teu nom, el de l’empresa i el de qui hi ha deixat comentaris. Aquí veuràs què
          porta cada fitxer abans d’enviar-lo, i en podràs baixar una còpia sense res de tot això.
        </p>

        <MetadataTool />

        <h2 id="per-que">Per què importa</h2>
        <ul>
          <li>
          ...
          <li>
            <strong>Instruccions d’IA:</strong> moltes imatges generades amb IA porten dins el text
            exacte que es va fer servir per crear-les.
          </li>
        </ul>

        <h2 id="com-neteja">Com es fa la còpia neta</h2>
        <p>
        ...
        <h2 id="de-bon-principi">Com evitar-ho de bon principi</h2>
        <ul>
          <li>
            <strong>iPhone:</strong> en compartir una foto, toca «Opcions» a dalt de tot i desactiva
            «Ubicació». Per no desar-la mai: Configuració › Privacitat i seguretat › Localització ›
            Càmera › «Mai».
          </li>
          <li>
          ...
          <li>
            <strong>Word:</strong> Fitxer › Informació › Comprova si hi ha problemes › Inspecciona el
            document, i elimina el que trobi a «Propietats del document i informació personal».
          </li>
          <li>
            <strong>LibreOffice:</strong> Eines › Opcions › LibreOffice › Seguretat › Opcions, i marca
            «Suprimeix la informació personal en desar».
          </li>
        </ul>
        <p>
        ...
        <ul>
          ...
          <li>
            No pot llegir el que un PDF desa comprimit dins la seva estructura interna, ni res d’un
            PDF xifrat. Quan passa, t’ho diu.
          </li>
          <li>
            No mira el contingut: una cara, una matrícula, un reflex o el nom d’un carrer a la foto
            diuen tant com les metadades, i això només ho pots revisar tu.
          </li>
          <li>
