  ...
  return (
    <div className="content-wrapper">
      <div className="text-page">
        ...
        <p className="lede">
          Esbrina en quines filtracions surt la teva adreça i què s’hi va exposar, comprova si les
          contrasenyes que fas servir ja circulen o si en repeteixes, i substitueix-les per unes de
          noves. Acabaràs amb una llista concreta del que has de canviar i on.
        </p>
        <nav aria-label="En aquesta pàgina" className="credentials-nav">
          <ul className="plain">
            <li>
              <a href="#correu">Filtracions de la teva adreça</a>
            </li>
            <li>
              <a href="#auditoria">Auditoria de contrasenyes</a>
            </li>
            <li>
              <a href="#generador">Generador</a>
            </li>
            <li>
              <a href="#gestors">Gestors de contrasenyes</a>
            </li>
            <li>
              <a href="#privadesa">Què surt del teu dispositiu</a>
            </li>
          </ul>
        </nav>
      ...
      <p>
        ...
        l’<a href="#auditoria">auditoria de contrasenyes</a> d’aquesta mateixa pàgina, que fa la
        consulta sense arribar a enviar mai cap contrasenya.
      </p>
      ...
      <p>
        ...
        <a href="#generador">generador d’aquesta pàgina</a> en fa, i explica quants bits
      ...
      <ul>
        ...
        <ul>
          <li>
            ...
            No carreguem els logotips que retorna XposedOrNot: cada imatge seria una petició més a un
            tercer que diria en quines filtracions surts.
          </li>
          <li>
      ...
      <p>
        ...
        del navegador, ves a la pestanya de xarxa i prem el botó d’auditar: hi veuràs una sola
        petició per contrasenya, a <code>/eines/api/pwned?prefix=</code> seguit de cinc caràcters. Res més. El codi
      ...
      <p>
        ...
        <ul className="plain">
          <li>
            ...
            , projecte obert de consulta de filtracions. L’API és gratuïta i sense clau per a ús no
            comercial, amb un límit de consultes per connexió, i les condicions demanen citar-ne
            la font. El lligam amb les fitxes del directori el fem nosaltres, a partir del{' '}
            <Link href="/filtracions">catàleg de filtracions</Link>.
          </li>
          <li>
