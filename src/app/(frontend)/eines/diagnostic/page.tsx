    ...
    <div className="content-wrapper">
      <div className="text-page tool-page">
        ...
        <details className="tool-more" id="privadesa">
          <summary>Privadesa: com pots comprovar que no es desa res enlloc més</summary>
          <p>
            Tot el càlcul passa dins del teu navegador. La pàgina arriba amb el directori ja
            preparat ({snapshot.publishedApps} fitxes i {snapshot.breaches.length} filtracions del
            catàleg lligables) i, a partir d’aquí, marcar serveis, completar accions o descarregar
            l’informe no genera cap petició de xarxa. Ho pots veure a la pestanya <em>Xarxa</em> de
