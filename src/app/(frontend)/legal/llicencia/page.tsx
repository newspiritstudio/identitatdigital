  ...
  return (
    <>
      ...
      <p className="lede">
        ...
        les persones arribi al màxim de gent possible. Per això el contingut és obert. Aquest document
        diu exactament què pots fer amb ell, amb quines condicions, i quins materials queden fora de
        la llicència perquè no són nostres per donar-los.
      </p>
      ...
      <ul>
        ...
        <li>
          <strong>Compartir igual.</strong> Si transformes el material o hi construeixes a sobre, has
          de distribuir la teva obra derivada amb la mateixa llicència o amb una de compatible.
        </li>
      </ul>
      <p>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>
                El text de cada aplicació: els detalls de cada afirmació, les notes, els resums i les
                valoracions escrites
              </td>
              <td>Dret d’autor sobre obra literària, article 10 del text refós de la LPI</td>
            </tr>
            <tr>
              <td>Les anàlisis i els incidents</td>
              <td>Les fitxes de sancions, resolucions i incidents, redactades i contextualitzades</td>
            ...
            <tr>
              ...
              <td>
                Dret d’autor sobre el text i sobre l’estructura. La idea de puntuar no és apropiable;
                la manera concreta d’expressar-la, sí
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                Quines aplicacions entren al directori, com es relacionen amb empreses i grups, i com
                s’ordena tot plegat
              </td>
              <td>
      ...
      <p>
        Identitat.digital encaixa exactament en el supòsit: la inversió no és en generar dades noves,
        sinó en <em>obtenir-les i verificar-les</em>, que és precisament el que la Directiva
        protegeix. Localitzar una política de privadesa, llegir-la, extreure’n l’afirmació rellevant,
        contrastar-la amb una resolució d’una autoritat de control, datar-la i enllaçar-la, cent
        vegades per fitxa, és una inversió substancial en verificació.
      </p>
      <p>
        Aquest dret existeix encara que no el reclamem, i dura quinze anys des de la finalització de
        la base de dades, renovables amb cada modificació substancial. Per tant, si volem que la gent
        pugui reutilitzar el conjunt, <strong>no n’hi ha prou de llicenciar el dret d’autor</strong>:
        cal llicenciar també el dret sui generis. Si no, algú podria copiar legítimament el text d’una
        fitxa i, en canvi, tenir problemes per descarregar-se el conjunt sencer, que és justament el
        que volem que pugui fer un mitjà, una universitat o una altra organització.
      </p>
      <Avis>
        <p>
          ...
          obligacions corresponents. Les llicències 3.0 no ho feien: el dret sui generis hi quedava en
          un territori ambigu, gestionat de manera diferent segons la versió adaptada a cada
      ...
      <p>
        La decisió estava entre tres opcions reals. Aquestes són, amb el que s’hi guanya i el que s’hi
        perd.
      </p>

      <h3>Reconeixement 4.0 (CC BY)</h3>
      <p>
        <strong>A favor:</strong> és la que menys fricció genera. Qualsevol pot agafar el contingut i
        fer-ne el que vulgui amb només citar-nos. És la que fa circular més ràpid la informació, que
        és l’objectiu del projecte.
      </p>
      <p>
        <strong>En contra:</strong> permet que algú es baixi les vint-i-cinc fitxes, les
        vint-i-nou empreses i les cent una fonts, en faci un producte tancat, hi posi publicitat o un
        mur de pagament, i no torni res. No és un problema teòric: una base de dades verificada
        d’aquesta mena és exactament el material que una empresa d’extracció de dades voldria
        incorporar sense contribuir-hi. El projecte hi hauria posat la inversió de verificació i
        perdria el control sobre si el resultat continua sent públic.
      </p>
      ...
      <p>
        ...
        restricció que sobre aquell material no existeix, i li faríem impossible saber quina part pot
        fer servir comercialment i quina no. Amb BY-SA això no passa: les condicions de BY-SA són més
        exigents que les de BY, però no n’anul·len cap llibertat —la comercial hi continua permesa—,
        de manera que incorporar material BY 4.0 en un conjunt BY-SA 4.0 és una operació neta, sempre
        que se’n mantingui l’atribució, que és el que fem.
      </p>
      <p>
        A això s’hi afegeix que «no comercial» no té una definició clara. Un professor que cobra?
        Una associació que ven samarretes? Un bloc amb un banner? La incertesa desanima justament els
        usos que volem.
      </p>
      ...
      <p className="meta">
        Si reutilitzes una fitxa nostra, pots reproduir-ne el text sota CC BY-SA 4.0. Per reproduir-ne
        el logotip, has de tenir una base pròpia per fer-ho: l’ús identificatiu que es descriu a
        l’apartat 7, el dret de citació, o el permís del titular.
      </p>
      ...
      <p>
        ...
        d’ús o d’una resolució administrativa, aquell fragment continua sent propietat del seu autor.
      </p>
      <p>
      ...
      <p>
        Conseqüència pràctica: aquests fragments no els sublicenciem. Si els reutilitzes, ho fas sota
        el teu propi dret de citació, i has de complir-ne les mateixes condicions.
      </p>
      ...
      <p>
        Aquest material conserva la seva pròpia llicència: no el sublicenciem sota CC BY-SA, perquè no
        cal i perquè no ens correspon. El que sí que és nostre, i sí que és CC BY-SA 4.0, és el
      ...
      <p>
        ...
        precisament el que t’exigim en atribuir-nos—, però no pots fer-los servir per identificar els
        teus propis productes o serveis, ni de manera que suggereixi que el que fas ve de nosaltres o
        que l’aprovem.
      </p>
      ...
      <p>
        Com a titulars dels drets, i en paral·lel a la llicència CC BY-SA 4.0, concedim aquest permís
        addicional. Qui vulgui pot acollir-s’hi en comptes d’acollir-se a la clàusula de compartir
        igual:
      </p>
      <Avis>
        <p>
        ...
        <ul>
          ...
          <li>
            Que s’indiqui la data de consulta, perquè el contingut canvia quan canvien les polítiques
            de les empreses.
          </li>
          <li>
            Que les dades no es modifiquin ni es descontextualitzin. Es poden retallar i maquetar; no
            es poden alterar les xifres, els estats ni les afirmacions.
          </li>
      ...
      <p>
        ...
        disponible, amb totes les seves llibertats intactes. Només afegeix una via per a l’ús que més
        volem afavorir i que és, alhora, el que la clàusula de compartir igual més podria espantar.
      </p>
      <p className="meta">
        Al marge de tot això, el dret de citació de l’article 32 i el dret d’informació de premsa
        existeixen tant si concedim permisos com si no. Ningú no necessita la nostra autorització per
        citar-nos en una notícia.
      </p>
      ...
      <p>
        Aquest ús no infringeix cap marca. El fonament és doble i coincident:
      </p>
      <ul>
        <li>
      ...
      <p>
        Tots dos preceptes estableixen el mateix: el titular d’una marca <strong>no pot prohibir</strong>{' '}
        a un tercer l’ús del signe quan es fa per <strong>identificar o referir-se a productes o
        serveis com a propis del titular</strong>, especialment quan és necessari per indicar la
        destinació d’un producte o d’un servei. És el que s’anomena ús referencial o nominatiu, i és
        exactament el que fem: assenyalar de quin producte parlem.
      </p>
      <p>
        La condició que hi posen tots dos articles és que l’ús sigui conforme a les pràctiques lleials
        en matèria industrial o comercial. El compliment, punt per punt:
      </p>
      <TableWrap>
        <table>
          <thead>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                Cada afirmació negativa va acompanyada del seu estat, el seu nivell d’evidència i les
                seves fonts. No hi ha judicis de valor sense base documental, ni desqualificacions
                personals, ni llenguatge vexatori. El que és desconegut es marca com a desconegut i no
                penalitza la puntuació.
              </td>
            </tr>
            <tr>
              <td>No fer-ne un ús a títol de marca pròpia</td>
              <td>
                No venem res sota aquests signes, no els incorporem a la nostra identitat visual i no
                els fem servir per distingir cap servei nostre.
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <p>
        A tot això s’hi afegeix que l’activitat del lloc és informativa i crítica, i que la llibertat
        d’informació de l’article 20.1.d de la Constitució empara parlar de productes que arriben a
        milions de persones. El règim de la comparació publicitària de la Llei 3/1991 de competència
        deslleial ni tan sols hi entra, perquè no competim amb aquestes empreses ni oferim cap
        producte alternatiu; però, com que el comparador del lloc posa serveis un al costat de
        l’altre, complim igualment els seus requisits: comparem només serveis que cobreixen la
        mateixa necessitat, amb característiques objectives, verificables i representatives, i
        idèntiques per a tots.
      </p>
      ...
      <p>
        ...
        concret, la pàgina on és i la teva titularitat. Ho revisarem amb diligència i, si tens raó, ho
        retirarem o ho corregirem. Si no hi estem d’acord, t’explicarem per què, amb el raonament a la
        vista. No retirem contingut verificat només perquè algú ho demani, però tampoc no mantenim res
        que no puguem sostenir.
      </p>
      <p>
      ...
      <h2>9. Referències</h2>
      <ul>
        <li>Reial decret legislatiu 1/1996, text refós de la Llei de propietat intel·lectual: articles 10, 12, 32 i 133 a 137.</li>
        ...
        <li>Text legal de la llicència Creative Commons Reconeixement-CompartirIgual 4.0 Internacional, secció 4, sobre drets sui generis de bases de dades.</li>
      </ul>
    </>
  )
}
