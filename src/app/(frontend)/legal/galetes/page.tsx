  ...
  return (
    <>
      ...
      <p className="lede">
        ...
        continuació expliquem per què això és legal, per què és preferible i com pots comprovar-ho tu
        mateix en trenta segons.
      </p>
      ...
      <p>
        ...
        els prestadors poden utilitzar dispositius d’emmagatzematge i recuperació de dades als equips
        terminals dels destinataris —això és el que fan les galetes, però també l’emmagatzematge
        local i qualsevol tècnica equivalent— sempre que els hagin donat informació clara i completa
        i n’hagin obtingut el consentiment.
      </p>
      <p>
        El mateix article estableix dues excepcions: no cal consentiment quan l’emmagatzematge serveix
        únicament per efectuar la transmissió d’una comunicació per una xarxa de comunicacions
        electròniques, o quan és <strong>estrictament necessari</strong> per prestar un servei
        expressament sol·licitat per la persona usuària.
      </p>
      <p>
      ...
      <p>
        Aquí el raonament és molt més senzill que tot això: <strong>no hi ha cap galeta a la qual
        aplicar l’excepció</strong>, perquè no n’hi ha cap. Un bàner de consentiment que no demana
        consentiment per a res no informa de res. Seria una molèstia decorativa, i el projecte
        considera que aquesta mena de decoració és part del problema que documenta.
      </p>

      <h2>Per què no n’hi ha, tècnicament</h2>
      <p>
        Perquè les decisions d’arquitectura ho impedeixen, no perquè ho hàgim promès:
      </p>
      <ul>
        <li>
          <strong>No hi ha comptes per a qui visita.</strong> Sense inici de sessió no cal cap galeta
          de sessió.
        </li>
        <li>
          <strong>Les pàgines es generen al servidor.</strong> El navegador rep HTML acabat; no hi ha
          cap estat que calgui recordar entre pàgines.
        </li>
        <li>
        ...
        <li>
          <strong>La política de seguretat de contingut bloqueja les connexions externes.</strong> La
          directiva <code>connect-src &apos;self&apos;</code> impedeix al navegador contactar amb cap
          servidor de tercers. Encara que algú hi introduís un rastrejador per error, no funcionaria.
        </li>
        <li>
          <strong>La capçalera de permisos desactiva l’API de temes de navegació</strong> de Chrome,
          que és el mecanisme amb què Google vol substituir les galetes de tercers. Aquest lloc no hi
          participa.
        </li>
      </ul>
      ...
      <p>
        ...
        les galetes que et posen els llocs que visites. Ho trobaràs a la configuració de privadesa de
        Chrome, Firefox, Safari, Edge o Brave. Bloquejar les galetes de tercers és una de les
      ...
      <h2>Referències</h2>
      <ul>
        <li>Article 22.2 de la Llei 34/2002, d’11 de juliol, de serveis de la societat de la informació i de comerç electrònic.</li>
        ...
        <li>Directrius 03/2022 del Comitè Europeu de Protecció de Dades sobre patrons enganyosos a les interfícies.</li>
        <li>Dictamen 4/2012 del Grup de Treball de l’article 29 sobre l’exempció de consentiment de determinades galetes.</li>
      </ul>
      <p className="meta">
